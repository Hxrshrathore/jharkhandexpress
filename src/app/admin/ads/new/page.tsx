  ...
  return (
    <div className="p-2 md:p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-border pb-6 gap-4">
        <div>
          <h1 className="text-4xl font-bold text-foreground tracking-tight" style={{ fontFamily: "'General Sans', sans-serif" }}>New Campaign Builder</h1>
          <p className="text-muted-foreground mt-2 text-sm font-medium">Construct intelligent auto-cascading ad pools.</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
                  ...
                  <div className="relative border-2 border-dashed border-border hover:border-emerald-500 rounded-lg aspect-video flex flex-col items-center justify-center cursor-pointer transition-colors group">
                    ...
                    {uploadingAd ? (
                      ...
                      <>
                        ...
                        <span className="text-[10px] text-muted-foreground mt-1 text-center font-medium">Formats: JPG, PNG, WEBP, GIF, MP4, WEBM</span>
                      </>
                    )}
                  </div>
                </div>
          ...
          >
            {savingCampaign ? <Loader2 className="w-5 h-5 animate-spin mr-2" /> : <Camera className="w-5 h-5 mr-2" />} LAUNCH CAMPAIGN INTO DATABASE
          </Button>
        </CardContent>
      </Card>
